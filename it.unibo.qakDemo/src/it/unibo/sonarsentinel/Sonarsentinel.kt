...
package it.unibo.sonarsentinel
...
class Sonarsentinel ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("doWork") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t020",targetState="handleSonar",cond=whenEvent("sonar"))
				}	 
