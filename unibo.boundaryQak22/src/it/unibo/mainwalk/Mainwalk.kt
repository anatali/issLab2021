...
class Mainwalk ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("boundarywalk") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t01",targetState="endTest",cond=whenDispatch("mapDone"))
				}	 
