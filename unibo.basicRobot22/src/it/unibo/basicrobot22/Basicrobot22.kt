		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						println("basicrobot22 | START")
						unibo.robot.robotSupport.create(myself ,"basicrobot22Config.json" )
						 RobotType = unibo.robot.robotSupport.robotKind  
						delay(1000) 
						if(  RobotType != "virtual"  
						 ){ var robotsonar = context!!.hasActor("realsonar")  
						        	   unibo.robot.robotSupport.createSonarPipe(robotsonar)
						}
						unibo.robot.robotSupport.move( "l"  )
						unibo.robot.robotSupport.move( "r"  )
						updateResourceRep( "basicrobot22(start)"  
						)
					}
				...
				state("doStep") { //this:State
					action { //it:State
						...
						println("basicrobot22 | doStep StepTime =$StepTime  ")
						unibo.robot.robotSupport.move( "w"  )
						stateTimer = TimerActor("timer_doStep", 
							scope, context!!, "local_tout_basicrobot22_doStep", StepTime )
					}
					 transition(edgeName="t04",targetState="stepDone",cond=whenTimeout("local_tout_basicrobot22_doStep"))   
				...
				state("stepDone") { //this:State
					action { //it:State
						...
						println("basicrobot22 | stepDone reply done")
					}
					 transition( edgeName="goto",targetState="work", cond=doswitch() )
				}	 
				state("stepFail") { //this:State
					action { //it:State
						...
						println("basicrobot22 | stepFail duration=$Duration TunedDuration=$TunedDuration")
						unibo.robot.robotSupport.move( "s"  )
						delay(TunedDuration)
						unibo.robot.robotSupport.move( "h"  )
				...
				state("endwork") { //this:State
					action { //it:State
						updateResourceRep( "basicrobot22(end)"  
						)
						terminate(1)
					}
				}	 
