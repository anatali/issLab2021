...
class ResourceDataHandler implements CoapHandler {
...
public class ResourceObserverRadar {
	private CoapSupport coapSupport = new CoapSupport("coap://localhost:5683","robot/sonar");
	...
	public ResourceObserverRadar(){
		...
		coapSupport.observeResource( new ResourceDataHandler() );
	}
