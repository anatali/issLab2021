...
class MobotDataHandler implements CoapHandler {
...
public class SonarMbotlabObserverRadar {
	private CoapSupport coapSupport = 
			new CoapSupport("coap://192.168.1.40:8037","ctx???/???");
	
	public SonarMbotlabObserverRadar(){
		radarPojo.radarSupport.setUpRadarGui();
		System.out.println("   ResourceObserverRadar | STARTS ");
		coapSupport.observeResource( new MobotDataHandler() );
	}
	
	public static void main(String[] args) {
  		SonarMbotlabObserverRadar rco = new SonarMbotlabObserverRadar();
	}
