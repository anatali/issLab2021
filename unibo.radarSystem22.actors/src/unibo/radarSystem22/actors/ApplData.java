...
public class ApplData {
	public static final String raspAddr       = "192.168.1.3";
	public static final String pcAddr         = "localhost";
	...
	public static final int ctxRaspPort      = 8018;
	public static final int ctxPcPort        = 8016;
